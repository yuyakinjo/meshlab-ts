...
CASES = [
    ...
    # --- second sweep: transforms, more smoothing, boundary behaviour -----
    (
        "torus-trs",
        "torus.ply",
        "compute_matrix_from_translation_rotation_scale",
        {"translationX": 0.5, "rotationZ": 30.0, "scaleX": 1.5, "scaleY": 1.5, "scaleZ": 1.5},
        "exact",
    ),
    (
        "torus-flipswap",
    ...
    ("torus-reorient-geom", "torus.ply", "meshing_re_orient_faces_by_geometry", {}, "exact"),
    (
        "sphere-butterfly",
        "sphere.ply",
    ...
    ("sphere3-hc", "sphere3.ply", "apply_coord_hc_laplacian_smoothing", {}, "equivalent"),
    (
        "sphere3-sd",
        "sphere3.ply",
        "apply_coord_laplacian_smoothing_scale_dependent",
        {"stepSmoothNum": 3, "delta": {"abs": 0.01}},
        "equivalent",
    ),
    (
        "sphere3-unsharp",
        ...
        {"weight": 0.3, "weightOrig": 1.0, "iterations": 5},
        "equivalent",
    ),
    (
        "plane-laplacian-1d",
        "plane.ply",
        "apply_coord_laplacian_smoothing",
        {"stepSmoothNum": 5, "cotangentWeight": False, "Boundary": True},
        "equivalent",
    ),
    (
        "plane-laplacian-full",
        "plane.ply",
        "apply_coord_laplacian_smoothing",
        {"stepSmoothNum": 5, "cotangentWeight": False, "Boundary": False},
        "equivalent",
    ),
    (
        "plane-taubin",
        "plane.ply",
        "apply_coord_taubin_smoothing",
        {"lambda": 0.5, "mu": -0.53, "stepSmoothNum": 6},
        "equivalent",
    ),
    ("islands-hull", "islands.ply", "generate_convex_hull", {}, "equivalent"),
    (
        "tetra-midpoint-torus",
        "torus.ply",
        "meshing_surface_subdivision_midpoint",
        {"Iterations": 1, "Threshold": {"abs": 0.0}},
        "exact",
    ...
    (
        ...
        "cube_with_holes.stl",
        "meshing_close_holes",
        {"MaxHoleSize": 30, "RefineHole": True, "RefineHoleEdgeLen": {"abs": 0.3}},
        "loose",
    ),
    (
        "plane-qecd-boundary",
        "plane.ply",
        "meshing_decimation_quadric_edge_collapse",
        {"TargetFaceNum": 30, "PreserveBoundary": True},
        "loose",
    ),
    (
        "sphere3-isotropic",
        ...
        {"Iterations": 3, "TargetLen": {"abs": 0.15}},
        "loose",
    ),
]
